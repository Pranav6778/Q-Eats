...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    ...
    restaurant1 = restaurants[0];System.out.println(restaurant1);
    restaurant2 = restaurants[1];System.out.println(restaurant2);
    restaurant3 = restaurants[2];System.out.println(restaurant3);
    restaurant4 = restaurants[3];System.out.println(restaurant4);
    restaurant5 = restaurants[4];System.out.println(restaurant5);
